function [uout,error_flag,iter] = velocity_solve_fix(u,h,x_g,parameters,flags)
...
%Dupont lateral shear stress coefficient
Gout = parameters.Dupont_G.*ones(size(x));
end